...
BUSD reflection Token design by BigB
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // Current BUSD Mainnet 
...
contract TGTOKEN is IBEP20, Auth {
    ...
    string constant _name = "TBA";
    string constant _symbol = "TBA";
    ...
    constructor () Auth(msg.sender) {
        ...
        // WORKS BIGB - autoLiquidityReceiver can be set to DEAD if needed. 
